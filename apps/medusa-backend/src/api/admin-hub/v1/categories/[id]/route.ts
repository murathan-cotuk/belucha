/**
 * Admin Hub Category by ID API v1
 * 
 * GET /admin-hub/v1/categories/:id - Kategori detayı
 * PUT /admin-hub/v1/categories/:id - Kategori güncelle
 * DELETE /admin-hub/v1/categories/:id - Kategori sil
 */
